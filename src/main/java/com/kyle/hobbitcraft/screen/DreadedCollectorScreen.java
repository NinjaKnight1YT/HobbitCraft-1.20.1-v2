...
public class DreadedCollectorScreen extends AbstractContainerScreen<DreadedCollectorMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(HobbitCraft.MOD_ID, "textures/gui/dreaded_collector_gui.png");

    public DreadedCollectorScreen(DreadedCollectorMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
