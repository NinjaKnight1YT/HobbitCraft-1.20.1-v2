...
public class VinoCollectorScreen extends AbstractContainerScreen<VinoCollectorMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(HobbitCraft.MOD_ID, "textures/gui/vino_collector_gui.png");

    public VinoCollectorScreen(VinoCollectorMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
