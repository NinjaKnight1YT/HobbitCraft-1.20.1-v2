...
public class KyleCollectorScreen extends AbstractContainerScreen<KyleCollectorMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(HobbitCraft.MOD_ID, "textures/gui/kyle_collector_gui.png");

    public KyleCollectorScreen(KyleCollectorMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
