...
public class HobbitCraftiumCollectorScreen extends AbstractContainerScreen<HobbitCraftiumCollectorMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(HobbitCraft.MOD_ID, "textures/gui/hobbitcraftium_collector_gui.png");

    public HobbitCraftiumCollectorScreen(HobbitCraftiumCollectorMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
